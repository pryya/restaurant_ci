...
$this->db->update('daftar_menu', $data);
   ...
   $tott = $ttl->total1;
      ...
      /* $id_pesanan		= $this->input->post('id_pesanan', $keyword);
...
return $this->db->insert('detail_transaksi', $data); */
  ...
  /*   //COMBOBOX nama_mesnu
    function nama($id_menu)
    {
      ...
      return $this->db->from('dafta_menu')->get()->result();
    } */
	...
	if($data==0){
      ...
      $data 		= array('id_pesanan'		=>$kodejadi,
                'jlm_pesan'		=>$jlm_pesan,
                'no_meja'	=>$no_meja,
                'harga_satuan'	=>$harga_satuan,
                'tgl_pesan'	=>$tgl_pesan,
...
$this->db->update('pesanan', $data1);
        ...
        $data 		= array('id_transaksi'		=>$kodejadi,
