...
<br><br>
<form action="<?php echo site_url('owner/cari_transaksi');?>" methot="post">
...
<a href="<?php echo site_url('owner/cari_transaksi'); ?>" class="btn btn-danger" id="diprint" style="text-decoration:none; color: black;">Reset</a>
