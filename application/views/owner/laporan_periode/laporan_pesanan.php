...
<br><br>
<form action="<?php echo site_url('owner/cari_pesanan');?>" methot="post">
...
<a href="<?php echo site_url('owner/cari_pesanan'); ?>" class="btn btn-danger" id="diprint" style="text-decoration:none; color: black;">Reset</a>
